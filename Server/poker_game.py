...
from banker_play_alone import BankerPlayAlone
from team_play import TeamPlay
    ...
    def _team(self):
        ...
        for i, hand_cards in enumerate(self._hand_cards):
            ...
            if self._banker_card in hand_cards:
                a, b = set(range(4)) - {self._banker_seat, i}
                teams = [0] * 4
                teams[a] = teams[b] = 1
                self._battle_manager = TeamPlay(self._banker_seat, self._banker_card, teams, i)
                return
